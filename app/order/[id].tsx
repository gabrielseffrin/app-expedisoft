                ...
                <>
                    <Card style={styles.card}>
                        ...
                        <View style={styles.gridContainer}>
                            <View style={styles.gridItem}>
                                ...
                                <Text style={styles.gridValue}>{order.customer}</Text>
                            </View>
                            <View style={styles.gridItem}>
                    ...
                    <Card style={styles.card}>
                        <View style={styles.progressHeader}>
                            ...
                            <Text style={styles.progressText}>{(packagesConferred / totalPackages) * 100}%</Text>
                        </View>
                        <View style={styles.progressBarBackground}>
                            <View style={[styles.progressBarFill, {width: `${progressPercentage}%`}]}/>
                        </View>
                        <View>
                            <Text style={styles.progressTextInfo}>{packagesConferred} de {totalPackages} conferidos.</Text>
                        </View>
                    </Card>
...
const styles = StyleSheet.create({
    ...
    progressBarBackground: {
        ...
        borderRadius: 10,
        overflow: 'hidden',
        marginBottom: 8, // Adicionado para dar respiro ao texto de baixo
    },
    progressBarFill: {
        height: '100%',
    ...
    packageHeader: {
        ...
        paddingBottom: 12,
        borderBottomWidth: 1,
        borderBottomColor: '#F3F4F6', // Linha sutil
    },
    packageTitle: {
        fontSize: 16,
        fontWeight: 'bold',
    ...
    packageLabel: {
        ...
        color: '#6B7280',
        marginBottom: 2,
        textTransform: 'uppercase', // Ar mais logístico
    },
    packageProductName: {
        fontSize: 16,
        color: '#111827',
